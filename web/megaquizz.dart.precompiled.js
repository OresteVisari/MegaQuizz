...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__processWorkerMessage_closure: {
    "^": "Closure:7;entryPoint_0,args_1,message_2,isSpawnUri_3,replyTo_4",
    call$0: function() {
  ...
  _Future__propagateToListeners_handleValueCallback: {
    ...
    call$0: function() {
      ...
      try {
        ...
        t3 = this.box_2.source_4.get$_async$_value();
        t1.toString;
...
["", "megaquizz.dart", , T, {
  "^": "",
  main: [function() {
    var t1 = J.get$onClick$x(document.querySelector("#title"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new T.main_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    T.displayMainMenu();
  }, "call$0", "main$closure", 0, 0, 1],
  displayMainMenu: function() {
    J.get$children$x($.get$content()).clear$0(0);
    $.curentQuestion = 0;
    $.score = 0;
    $.get$sub_title().textContent = "Pour apprendre tout en jouant";
    for (var t1 = new H.ListIterator($.get$listOfQuizz(), 4, 0, null); t1.moveNext$0();)
      T.addQuizz(t1._current);
  },
  addQuizz: function(id) {
    var button, t1, t2, t3, t4;
    button = W.InputElement_InputElement("image");
    t1 = J.getInterceptor$x(button);
    t1.get$classes(button).add$1(0, "buttonQuizz");
    t1.set$src(button, "images/quizz/" + H.S(id) + ".png");
    t1 = t1.get$onClick(button);
    t2 = t1._eventType;
    t3 = t1._useCapture;
    t4 = new W._EventStreamSubscription(0, t1._target, t2, W._wrapZone(new T.addQuizz_closure(id)), t3);
    t4.$builtinTypeInfo = [H.getTypeArgumentByIndex(t1, 0)];
    t1 = t4._onData;
    if (t1 != null && t4._pauseCount <= 0)
      J.addEventListener$3$x(t4._target, t2, t1, t3);
    J.get$children$x($.get$content()).add$1(0, button);
  },
  displayQuizz: [function(file) {
    var t1 = C.JsonCodec_null_null.decode$1(file);
    $.quizz = t1;
    $.get$sub_title().textContent = J.$index$asx(t1, "description");
    T.displayQuestion();
  }, "call$1", "displayQuizz$closure", 2, 0, 6],
  displayQuestion: function() {
    var question, parQuestion, t1, answers, solution, i, t2;
    J.get$children$x($.get$content()).clear$0(0);
    question = J.$index$asx(J.$index$asx($.quizz, "questions"), $.curentQuestion);
    parQuestion = document.createElement("p", null);
    t1 = J.getInterceptor$asx(question);
    parQuestion.textContent = t1.$index(question, "question");
    J.get$children$x($.get$content()).add$1(0, parQuestion);
    answers = t1.$index(question, "answers");
    solution = J.$sub$n(H.Primitives_parseInt(t1.$index(question, "solution"), null, null), 1);
    t1 = J.getInterceptor$asx(answers);
    i = 0;
    while (true) {
      t2 = t1.get$length(answers);
      if (typeof t2 !== "number")
        return H.iae(t2);
      if (!(i < t2))
        break;
      if (i === solution)
        T.addAnswer(t1.$index(answers, i), true);
      else
        T.addAnswer(t1.$index(answers, i), false);
      ++i;
    }
    t1 = $.curentQuestion;
    if (typeof t1 !== "number")
  ...
  addAnswer: function(text, value) {
    var divAnswer, buttonAnswer, t1, t2, t3, t4;
    divAnswer = document.createElement("div", null);
    buttonAnswer = document.createElement("button", null);
    buttonAnswer.textContent = text;
    t1 = J.get$onClick$x(buttonAnswer);
    t2 = t1._eventType;
    t3 = t1._useCapture;
    t4 = new W._EventStreamSubscription(0, t1._target, t2, W._wrapZone(new T.addAnswer_closure(value)), t3);
    t4.$builtinTypeInfo = [H.getTypeArgumentByIndex(t1, 0)];
    t1 = t4._onData;
    if (t1 != null && t4._pauseCount <= 0)
      J.addEventListener$3$x(t4._target, t2, t1, t3);
    J.get$children$x(divAnswer).add$1(0, buttonAnswer);
    J.get$children$x($.get$content()).add$1(0, divAnswer);
  },
  main_closure: {
    "^": "Closure:9;",
    call$1: function(e) {
  ...
  addAnswer_closure: {
    ...
    call$1: function(e) {
      ...
      t1 = $.curentQuestion;
      t2 = J.get$length$asx(J.$index$asx($.quizz, "questions"));
      if (typeof t1 !== "number")
        return t1.$lt();
      if (typeof t2 !== "number")
        return H.iae(t2);
      if (t1 < t2)
        ...
        J.get$children$x($.get$content()).add$1(0, parScore);
        J.get$children$x($.get$content()).add$1(0, parBestScore);
      }
      return;
    }
  }
...
Isolate.$lazy($, "content", "content", "get$content", function() {
  return document.querySelector("#sample_container_id");
});
...
Isolate.$lazy($, "listOfQuizz", "listOfQuizz", "get$listOfQuizz", function() {
  return ["logiciel-libre", "litterature-classique", "cinema", "one-piece"];
});
// Native classes
